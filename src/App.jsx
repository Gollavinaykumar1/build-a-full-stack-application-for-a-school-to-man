        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build A Full Stack Application For A School</span>
            </Link>
            <div className="flex items-center gap-3">
              ...
              <Link to="/new" className="btn-primary text-sm py-2 px-4">+ Add Session</Link>
            </div>
          </div>
        </div>
      </nav>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build A Full Stack Application For A School</h1>
          <p className="text-gray-500 mt-1 text-sm">Powered by VIA — Autonomous AI Platform</p>
        </div>
        <Link to="/new" className="btn-primary">+ Add Session</Link>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <StatCard title="Total Sessions" value={stats?.total ?? 0} loading={loading} color="blue" />
        <StatCard title="Active" value={stats?.active ?? 0} loading={loading} color="green" />
        <StatCard title="Platform" value={"Multi"} loading={loading} color="purple" />
      </div>
      <div className="card">
        ...
        {loading ? <Spinner /> : items.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-gray-400 mb-4">No game sessions yet</p>
            <Link to="/new" className="btn-primary inline-block">+ Add Session</Link>
          </div>
        ) : (
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <Link to="/new" className="btn-primary whitespace-nowrap">+ Add Session</Link>
        </div>
      </div>
      {filtered.length === 0 ? (
        <div className="card text-center py-20">
          <p className="text-5xl mb-4">⚡</p>
          <p className="text-gray-400 text-lg mb-6">No game sessions yet</p>
          <Link to="/new" className="btn-primary inline-block">+ Add Session</Link>
        </div>
      ) : (
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50/80 border-b border-gray-100">
              <tr>
                ...
                <th className="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Game</th><th className="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Score</th>
            ...
            <tbody className="divide-y divide-gray-50">
              {filtered.map(item => (
                <tr key={item.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-5 py-4 text-gray-600">{item.game_name || "—"}</td><td className="px-5 py-4 font-bold text-indigo-600">{item.score ?? 0}</td>
...
function ItemFormPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="card">
        <h1 className="text-2xl font-display font-bold text-gray-900 mb-6">New Game Session</h1>
